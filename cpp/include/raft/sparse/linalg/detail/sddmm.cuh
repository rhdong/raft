...
/**
 * @brief SDDMM function designed for handling all CSR * DENSE
 ...
 * @param[in] is_row_major data layout of X,Z
 * @param[in] alpha scalar
 * @param[in] descr_x input dense descriptor
 * @param[in] descr_y input dense descriptor
 * @param[in] beta scalar
 * @param[out] descr_z output sparse descriptor
 */
