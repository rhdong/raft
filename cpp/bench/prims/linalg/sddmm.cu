...
static std::vector<SDDMMBenchParams<ValueType>> getInputs()
{
  ...
  std::vector<TestSize> data_size{{1024 * 1024, 128, 1024, 0.01},
                                  ...
                                  {1024 * 1024, 128, 1024, 0.101},
                                  {1024 * 1024, 128, 1024, 0.12},
                                  {1024 * 1024, 128, 1024, 0.14},
                                  {1024 * 1024, 128, 1024, 0.16},
                                  {1024 * 1024, 128, 1024, 0.18},
                                  {1024 * 1024, 128, 1024, 0.2},
                                  {1024 * 1024, 128, 1024, 0.249},
                                  {1024 * 1024, 128, 1024, 0.251},
                                  {1024 * 1024, 128, 1024, 0.3},
                                  {1024 * 1024, 128, 1024, 0.4},
                                  {1024 * 1024, 128, 1024, 0.5},
                                  {1024 * 1024, 1024, 1024, 0.01},
                                  {1024 * 1024, 1024, 1024, 0.1},
                                  {1024 * 1024, 1024, 1024, 0.2},
                                  {1024 * 1024, 1024, 1024, 0.249},
                                  {1024 * 1024, 1024, 1024, 0.251},
