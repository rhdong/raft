...
int main(void)
{
  std::vector<BenchParams> cases{{1024 * 1024, 128, 10, 1.0f, 0.0f, true, false},
                                 ...
                                 {1024 * 1024, 1024, 1024, 1.0f, 0.0f, false, true},
                                 {1024 * 1024, 1024, 2 * 1024, 1.0f, 0.0f, false, true},
                                 {1024 * 1024, 128, 1024, 1.0f, 0.0f, true, true},
                                 {1024 * 1024, 1024, 1024, 1.0f, 0.0f, true, true},
                                 {1024 * 1024, 1024, 2 * 1024, 1.0f, 0.0f, true, true},
                                 {1024 * 1024, 128, 1024, 1.0f, 0.0f, false, false},
                                 {1024 * 1024, 1024, 1024, 1.0f, 0.0f, false, false},
                                 {1024 * 1024, 1024, 2 * 1024, 1.0f, 0.0f, false, false}};
